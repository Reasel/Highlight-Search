...
search hiding everything else. Press **Enter** to jump to the ALL tab and
...
- Live highlighting as you type: items blink, then stay outlined (blink duration 0 = blink forever)
...
The plugin draws on top of the bank interface and leaves the native search and item filtering untouched.
